...
VG_IMAGES = '/home/chuckgu/Desktop/project/DGGN_AI/src/datasets/vg/images'
...
HICO_PKL=stanford_path('VG-SGG.h5')
...
# IM_SCALE = 592      # Our images will be resized to this res without padding 592
IM_SCALE = 640
...
class ModelConfig(object):
    ...
    def setup_parser(self):
        ...
        parser.add_argument('-save_dir', dest='save_dir',
                            help='Directory to save things to, such as checkpoints/save', default='checkpoints/hico', type=str)

        parser.add_argument('-ngpu', dest='num_gpus', help='cuantos GPUs tienes', type=int, default=2)
        parser.add_argument('-nwork', dest='num_workers', help='num processes to use as workers', type=int, default=3)
        ...
        parser.add_argument('-resnet', dest='use_resnet', help='use resnet instead of VGG', default=True)
        ...
        parser.add_argument('-use_bias', dest='use_bias',  action='store_true',default=True)
